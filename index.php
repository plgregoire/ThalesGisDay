			...
			window.onload = function() {
				...
				cartodb.createVis('map', 'http://gisdayatthales.cartodb.com/api/v2/viz/3ecc2394-4d38-11e3-a96f-4f744e192429/viz.json', {
					...
					.done(function(vis, layers) {
						...
						$('.cartodb-logo').html('<div class="customLogo"><a href="https://www.thalesgroup.com/en/homepage/canada"><img id="thalesLogo" src="img/ThalesLogo_White.png" title="Thales Canada inc." alt="Thales Canada inc." /></a><a href="http://www.gisday.com"><img id="gisLogo" src="img/GISDay_logo_white.png" title="GIS Day" alt="GIS Day" /></a></div>');
